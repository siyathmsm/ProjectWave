...
public class UploadSup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.upload_doc_supervisor);
       ...
       // docLbl = findViewById(R.id.docLbl); // This is assuming you have an EditText with id "docLbl"
        ...
        dbHandler = new DBHandler_UnSigned(UploadSup.this);
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (groupName.isEmpty() || feedbackIte.isEmpty()) {
                    Toast.makeText(UploadSup.this, "Please enter all the data.", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                Toast.makeText(UploadSup.this, "Document has been uploaded.", Toast.LENGTH_SHORT).show();
